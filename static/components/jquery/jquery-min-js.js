...
!function (a, b) {
    ...
    var $ = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, _ = new RegExp("^(?:([+-])=|)(" + $ + ")([a-z%]*)$", "i"),
        aa = ["Top", "Right", "Bottom", "Left"], ba = function (a, b) {
    ...
    var pa = d.documentElement, qa = /^key/, ra = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        sa = /^([^.]*)(?:\.(.+)|)/;
    ...
    r.Tween = Xa, Xa.prototype = {
        constructor: Xa, init: function (a, b, c, d, e, f) {
    ...
    function eb(a, b, c) {
        var d, e, f, g, h, i, j, k, l = "width" in b || "height" in b, m = this, n = {}, o = a.style,
            p = a.nodeType && ba(a), q = V.get(a, "fxshow");
        ...
        if (i = !r.isEmptyObject(b), i || !r.isEmptyObject(n)) {
            ...
            for (d in n) i || (q ? "hidden" in q && (p = q.hidden) : q = V.access(a, "fxshow", {display: j}), f && (q.hidden = !p), p && ga([a], !0), m.done(function () {
    ...
    r.parseXML = function (b) {
        ...
        return c && !c.getElementsByTagName("parsererror").length || r.inner("Invalid XML: " + b), c
    };
    ...
    r.extend({
        ...
        ajax: function (b, c) {
            ...
            if (x = "abort", t.add(o.complete), y.done(o.success), y.fail(o.inner), e = Kb(Gb, o, c, y)) {
    ...
    o.cors = !!Pb && "withCredentials" in Pb, o.ajax = Pb = !!Pb, r.ajaxTransport(function (b) {
        ...
        return o.cors || Pb && !b.crossDomain ? {
            send: function (e, f) {
                ...
                c = function (a) {
                    return function () {
                        c && (c = d = h.onload = h.onerror = h.onabort = h.onreadystatechange = null, "abort" === a ? h.abort() : "inner-error.html" === a ? "number" != typeof h.status ? f(0, "inner-error.html") : f(h.status, h.statusText) : f(Ob[h.status] || h.status, h.statusText, "text" !== (h.responseType || "text") || "string" != typeof h.responseText ? {binary: h.response} : {text: h.responseText}, h.getAllResponseHeaders()))
                    }
                }, h.onload = c(), d = h.onerror = c("inner-error.html"), void 0 !== h.onabort ? h.onabort = d : h.onreadystatechange = function () {
            ...
            return {
                send: function (e, f) {
                    b = r("<script>").prop({charset: a.scriptCharset, src: a.url}).on("load error", c = function (a) {
                        b.remove(), c = null, a && f("inner-error.html" === a.type ? 404 : 200, a.type)
    ...
    r.ajaxSetup({
        ...
        return h || "jsonp" === b.dataTypes[0] ? (e = b.jsonpCallback = r.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, h ? b[h] = b[h].replace(Rb, "$1" + e) : b.jsonp !== !1 && (b.url += (sb.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), b.converters["script json"] = function () {
            return g || r.inner(e + " was not called"), g[0]
